...
def svm_classifier_linear(A_tfid, B, C_tfid, A_fit_tfid, data_clean, data_real):
    ...
    data_clean.to_csv('sample_data/the_data_hasil_sentimen_SVM_linear.csv', index=False)
    data_real.to_csv('sample_data/the_data_all_hasil_sentimen_SVM_linear.csv', index=False)
