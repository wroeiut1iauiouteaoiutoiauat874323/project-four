...
from wordcloudnya import wordcloud_semua_nb, wordcloud_positif_nb, wordcloud_negatif_nb, wordcloud_semua_svm_nonlinear, wordcloud_positif_svm_nonlinear, wordcloud_negatif_svm_nonlinear, wordcloud_semua_svm_linear, wordcloud_positif_svm_linear, wordcloud_negatif_svm_linear
...
def index():
    ...
    if request.method == 'POST':
        ...
        overall_accuracy_svm_nonlinear, cr_svm_nonlinear, cm_svm_nonlinear, data_clean_svm_nonlinear, data_real_svm_nonlinear, jumlah_data_clean_svm_nonlinear = svm_classifier_nonlinear(A_tfid, B, C_tfid, A_fit_tfid, hasil_labelling_data_selected, hasil_labelling_data_all)

        overall_accuracy_svm_linear, cr_svm_linear, cm_svm_linear, data_clean_svm_linear, data_real_svm_linear, jumlah_data_clean_svm_linear = svm_classifier_linear(A_tfid, B, C_tfid, A_fit_tfid, hasil_labelling_data_selected, hasil_labelling_data_all)
