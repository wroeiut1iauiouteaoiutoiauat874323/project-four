...
def grafik_svm_linear(dr):
    ...
    # Simpan plot sebagai file gambar
    plt.savefig('static/grafik_svm_linear.png', format='png')

def grafik_svm_nonlinear(dr):
    dr['date'] = pd.to_datetime(dr['at'])
    dr = dr.sort_values(by='date')
    ...
    # Simpan plot sebagai file gambar
    plt.savefig('static/grafik_svm_nonlinear.png', format='png')