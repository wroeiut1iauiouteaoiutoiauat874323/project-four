...
def wordcloud_semua_svm(data):
    def plot_cloud(wordcloud):
        ...
        plt.gca().xaxis.set_major_locator(plt.NullLocator())
        plt.gca().yaxis.set_major_locator(plt.NullLocator())
        plt.savefig('static/wordcloud_semua_svm.png', format='png', bbox_inches='tight', pad_inches=0)
...
def wordcloud_positif_svm(data):
    def plot_cloud(wordcloud):
        plt.figure(figsize=(10, 8), tight_layout=True)
        plt.imshow(wordcloud, interpolation='bilinear')
        plt.axis('off')
        ...
        plt.gca().xaxis.set_major_locator(plt.NullLocator())
        plt.gca().yaxis.set_major_locator(plt.NullLocator())
        plt.savefig('static/wordcloud_positif_svm.png', format='png', bbox_inches='tight', pad_inches=0)
...
def wordcloud_negatif_svm(data):
    def plot_cloud(wordcloud):
        plt.figure(figsize=(10, 8), tight_layout=True)
        plt.imshow(wordcloud, interpolation='bilinear')
        plt.axis('off')
        ...
        plt.gca().xaxis.set_major_locator(plt.NullLocator())
        plt.gca().yaxis.set_major_locator(plt.NullLocator())
        plt.savefig('static/wordcloud_negatif_svm.png', format='png', bbox_inches='tight', pad_inches=0)
